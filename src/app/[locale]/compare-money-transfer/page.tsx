                ...
                <div key={p.slug} className="border-t border-[var(--color-outline)] first:border-t-0">
                  ...
                  <div className="sm:hidden p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="w-12 h-12 rounded-full overflow-hidden bg-white border border-[var(--color-outline)]/40 shrink-0 flex items-center justify-center">
                  ...
                  <div className="hidden sm:grid grid-cols-[40px_1fr_150px_140px_130px] gap-4 items-center px-6 py-4">
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="w-11 h-11 rounded-full overflow-hidden bg-white border border-[var(--color-outline)]/40 shrink-0">
              ...
              return (
                <Card key={item.category} className="h-full">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="w-12 h-12 rounded-full overflow-hidden bg-white border border-[var(--color-outline)]/40 shrink-0">
