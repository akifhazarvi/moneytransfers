...
// Mirrors the exchange-rates page. NEVER use `new Date()` at render scope here:
// it forces dynamic rendering and reintroduces the no-store regression.
export const revalidate = 3600;

// Build-time freshness signal derived from the live rates dataset, not the
// request clock. Keeps the page statically renderable.
const AS_OF_DATE = new Date((RATES_AS_OF || "2026-06-22") + "T00:00:00Z");
const monthYear = AS_OF_DATE.toLocaleDateString("en-US", { month: "long", year: "numeric", timeZone: "UTC" });
const fullDate = AS_OF_DATE.toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric", timeZone: "UTC" });
