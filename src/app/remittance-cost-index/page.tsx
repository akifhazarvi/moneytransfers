...
export const metadata: Metadata = {
  title: "2026 Global Remittance Cost Index — Average Fees & Markups by Provider",
  description:
    "The definitive ranking of international money transfer costs. We analyzed 60+ providers across 300+ corridors to reveal average fees, exchange rate markups, and the true cost of sending $1,000 abroad.",
  keywords:
  ...
  openGraph: {
    title: "2026 Global Remittance Cost Index | SendMoneyCompare",
    description:
      "Average fees, markups, and total costs for 60+ providers across 300+ corridors. Find out who is cheapest — and who is costing you the most.",
...
export default function RemittanceCostIndexPage() {
  return (
    <>
      {/* Hero */}
      ...
      <section className="bg-[var(--color-surface)] border-y border-[var(--color-outline)] py-10">
        <Container>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              { label: "Providers analyzed", value: `${totalProviders}+` },
      ...
      <section className="py-10 bg-[var(--color-surface-dim)] border-t border-[var(--color-outline)]">
        <Container>
          <div className="max-w-3xl mx-auto">
            <h3 className="text-[14px] font-semibold text-[var(--color-on-surface)] mb-2">Cite this index</h3>
