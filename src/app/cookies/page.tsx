...
export const metadata: Metadata = {
  ...
  description:
    "Learn about the cookies SendMoneyCompare uses, why we use them, and how you can manage your cookie preferences.",
  alternates: { canonical: "https://sendmoneycompare.com/cookies" },
  openGraph: {
    title: "Cookie Policy — SendMoneyCompare",
    description:
      "How SendMoneyCompare uses cookies and how you can manage your preferences.",
                    ...
                    <table className="w-full text-[13px] border border-[var(--color-outline)] rounded-lg overflow-hidden">
                      <thead>
                        <tr className="bg-[var(--color-surface-dim)]">
                          <th className="text-left px-4 py-3 font-medium text-[var(--color-on-surface)] border-b border-[var(--color-outline)]">Cookie</th>
                          <th className="text-left px-4 py-3 font-medium text-[var(--color-on-surface)] border-b border-[var(--color-outline)]">Purpose</th>
                          <th className="text-left px-4 py-3 font-medium text-[var(--color-on-surface)] border-b border-[var(--color-outline)]">Duration</th>
                        </tr>
                      </thead>
                      <tbody>
