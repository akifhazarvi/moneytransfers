...
export const metadata: Metadata = {
  title: "Terms of Service — Rules for Using SendMoneyCompare",
  description:
    "Read the Terms of Service for SendMoneyCompare. Understand your rights and responsibilities when using our money transfer comparison platform.",
  alternates: { canonical: "https://sendmoneycompare.com/terms" },
  openGraph: {
    title: "Terms of Service — SendMoneyCompare",
    description:
      "Terms and conditions for using the SendMoneyCompare comparison platform.",
