  ...
  return (
    <div className="flex-1">
      ...
      <select
        ...
        className="w-full px-3 py-2 rounded-lg border border-[var(--color-outline)] bg-[var(--color-surface-dim)] text-sm text-[var(--color-on-surface)] focus:outline-none focus-visible:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
      >
        {options.map((code) => {
