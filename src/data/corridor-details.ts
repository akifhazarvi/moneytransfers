...
const countryDetailsMap: Record<string, CountryDetails> = {
  ...
  india: {
    ...
    recipientRequirements: [
      ...
      { label: "Bank account number", description: "Use the account number shown in the recipient’s bank records; accepted formats depend on the provider", required: true, example: "50100002345678" },
