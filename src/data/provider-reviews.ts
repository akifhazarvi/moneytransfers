...
<p><strong>Our assessment:</strong> Xoom's reviews reflect a service that excels at what it does best — fast cash pickup and mobile reload — while falling short on pricing transparency. Users who choose Xoom for its delivery options tend to be satisfied; those expecting the best exchange rates are often disappointed.</p>`,
  ...
  },
  {
    ...
    editorRating: 8.0,
    editorVerdict:
      "TapTap Send is a standout service for diaspora remittances — zero fees on most corridors is a genuine differentiator, and a ~0.7% exchange rate markup keeps total costs highly competitive. The simplicity and transparency are exceptional: no hidden costs, no variable fees, no nasty surprises — what you see is what your family gets. The service delivers 95% of transfers in under 3 minutes. Coverage spans 80+ countries and 65+ currencies, it accepts debit cards, bank transfers, Google Pay, Apple Pay, and UPI (India), and a multi-currency account and card are available for UK and EU users. Holders of the highest Trustpilot rating in money transfer (4.7 from 32,000+ reviews) — TapTap Send should be in every comparison you run for Africa, South Asia, and beyond.",
    reviewer: "Akif Hazarvi",
    factChecker: "Awais Imran",
    howWeTested:
      "We sent 8 test transfers through TapTap Send across 6 corridors (GBP→GHS, GBP→KES, USD→NGN, GBP→PKR, USD→BDT, EUR→XOF) between January and March 2026. Transfers were funded via debit card and bank transfer. We compared the total receive amount against Wise, Remitly, and WorldRemit at the same time. Our automated scraping system collects TapTap Send rates every 6 hours across all supported corridors, giving us thousands of data points for rate comparison.",
    sections: [
      {
        id: "overview",
        heading: "Overview",
        content:
          `<p>TapTap Send was founded in 2018 by <strong>Michael Faye</strong>, who is also the founder of <a href="https://www.givedirectly.org/" target="_blank" rel="noopener noreferrer">GiveDirectly</a>, the pioneering direct cash transfer charity. The founding team includes veterans from <a href="/companies/worldremit">WorldRemit</a> and Wave — people who deeply understand the remittance market and its pain points.</p>\n\n<p>TapTap Send is regulated by the <a href="https://register.fca.org.uk/s/firm?id=001b000003U0PSEAA3" target="_blank" rel="noopener noreferrer">FCA</a> in the UK and FinCEN in the US. The company is headquartered in London and has raised significant venture capital funding.</p>\n\n<p><strong>What makes TapTap Send different:</strong> Zero fees on most corridors, a ~0.7% exchange rate markup (among the lowest in the market), and blazing speed — <strong>95% of transfers delivered in under 3 minutes</strong>. The service accepts debit cards, bank transfers, Google Pay, Apple Pay, and UPI (India). For UK and EU users, TapTap Send also offers a multi-currency account and debit card. Coverage spans <strong>80+ countries and 65+ currencies</strong>, making it one of the broadest specialist remittance networks available.</p>\n\n<p>The service is purpose-built for diaspora communities sending money home to developing countries. Unlike broader platforms, TapTap Send's focus on remittance corridors means it consistently negotiates competitive rates for the routes that matter most: Africa, South Asia, and the Middle East.</p>`,
      },
      {
        id: "fees",
        heading: "Transfer fees",
        content:
          "<p><strong>TapTap Send offers zero fees on the majority of its corridors.</strong> Some corridors do carry a small fee — TapTap Send is transparent about this at the time of quoting. The combination of zero or low fees and a ~0.7% exchange rate markup keeps total costs highly competitive.</p>\n\n<p><strong>Fee comparison on a $500 transfer to Ghana:</strong></p>\n\n<table>\n<tr><th>Provider</th><th>Fee</th><th>Rate markup</th><th>Total cost</th></tr>\n<tr><td>TapTap Send</td><td>$0</td><td>~0.7%</td><td>~$3.50</td></tr>\n<tr><td>Wise</td><td>~$4.50</td><td>0%</td><td>~$4.50</td></tr>\n<tr><td>WorldRemit</td><td>$2.99</td><td>~1.5%</td><td>~$10.49</td></tr>\n<tr><td>Western Union</td><td>$4.99</td><td>~2.0%</td><td>~$14.99</td></tr>\n</table>\n\n<p><strong>Key insight:</strong> On zero-fee corridors, TapTap Send's ~0.7% markup is lower than many competitors' all-in cost. Even on corridors with a small fee, total cost remains competitive. The receive amount shown in the app is exactly what arrives — no nasty surprises at checkout.</p>\n\n<p><strong>Funding methods:</strong> Debit card, bank transfer, Google Pay, Apple Pay, and UPI (India). Multiple payment methods keep TapTap Send accessible for a wide range of senders.</p>",
      },
      {
        id: "exchange-rates",
        heading: "Exchange rates",
        content:
          `<p>TapTap Send's exchange rate markup is approximately <strong>0.7%</strong> above the mid-market rate on most corridors — among the tightest spreads in the remittance industry. This is where TapTap Send generates its revenue on fee-free corridors.</p>\n\n<p><strong>Rate comparison across corridors (our measurements):</strong></p>\n\n<table>\n<tr><th>Corridor</th><th>TapTap markup</th><th>Wise markup + fee</th><th>Winner</th></tr>\n<tr><td>GBP → GHS</td><td>~0.7%</td><td>~0.6%</td><td>Near tie</td></tr>\n<tr><td>GBP → KES</td><td>~0.7%</td><td>~0.7%</td><td>Tie</td></tr>\n<tr><td>USD → NGN</td><td>~0.7%</td><td>~0.6%</td><td>Near tie</td></tr>\n<tr><td>GBP → PKR</td><td>~0.7%</td><td>~0.8%</td><td>TapTap Send</td></tr>\n<tr><td>EUR → XOF</td><td>~0.7%</td><td>~0.8%</td><td>TapTap Send</td></tr>\n<tr><td>USD → BDT</td><td>~0.7%</td><td>~0.9%</td><td>TapTap Send</td></tr>\n</table>\n\n<p><strong>Key finding:</strong> TapTap Send's consistent ~0.7% markup is remarkably tight for a zero-fee provider. On corridors like GBP→PKR and EUR→XOF, TapTap Send often delivers more to the recipient than <a href="/companies/wise">Wise</a> when the latter's fee is factored in. Both are dramatically cheaper than banks or PayPal.</p>`,
      },
      {
        id: "speed",
        heading: "Delivery speed",
        content:
          `<p>TapTap Send is one of the fastest remittance services available: <strong>95% of transfers are delivered in under 3 minutes</strong>, across both mobile money and bank deposit channels.</p>\n\n<table>\n<tr><th>Delivery method</th><th>Typical speed</th></tr>\n<tr><td>Mobile money (M-Pesa, MTN, Wave)</td><td>Under 3 minutes in the vast majority of cases</td></tr>\n<tr><td>Bank deposit</td><td>Under 3 minutes to 1 business day</td></tr>\n</table>\n\n<p>In our testing, mobile money transfers to Kenya (M-Pesa) arrived in under 3 minutes. Bank deposits to Pakistan arrived within minutes during banking hours. Transfers to Ghana via MTN Mobile Money were consistently under 3 minutes.</p>\n\n<p>TapTap Send is among the fastest remittance providers for African and South Asian corridors — the 95% under-3-minutes figure is a genuine competitive differentiator that few rivals can match.</p>`,
      },
      {
        id: "countries",
        heading: "Countries and coverage",
        content:
          "<p>TapTap Send supports <strong>80+ receive countries across 65+ currencies</strong> (including both sender and receiver currencies). You can send from the UK, US, Canada, and many European countries.</p>\n\n<p><strong>Strongest corridors:</strong></p>\n<ul>\n<li><strong>Africa:</strong> Ghana, Kenya, Nigeria, Senegal, Uganda, Ethiopia, Rwanda, Cameroon, Tanzania, Zimbabwe, Morocco, Democratic Republic of Congo, and many more</li>\n<li><strong>South Asia:</strong> Pakistan, Bangladesh, Nepal, Sri Lanka, India</li>\n<li><strong>Latin America:</strong> Colombia, Mexico, Guatemala, and others</li>\n<li><strong>Asia-Pacific:</strong> Philippines, and growing</li>\n</ul>\n\n<p><strong>Payment methods:</strong> Debit card, bank transfer, Google Pay, Apple Pay, and UPI (for senders in India).</p>\n\n<p><strong>Multi-currency account:</strong> Available for UK and EU users — TapTap Send offers a multi-currency account and card in these markets.</p>\n\n<p>With 80+ countries covered, TapTap Send now rivals the reach of most major remittance providers. The combination of low markup, fast delivery, and broad coverage makes it a strong primary option rather than a niche supplement.</p>",
      },
      {
        id: "reviews",
        heading: "User reviews and reputation",
        content:
          "<p>TapTap Send holds a Trustpilot rating of <strong>4.7 out of 5</strong> from over <strong>32,000 reviews</strong> — the highest Trustpilot rating of any money transfer provider. This is a remarkable achievement reflecting exceptional and consistent service delivery across millions of transfers.</p>\n\n<p><strong>What users love:</strong></p>\n<ul>\n<li>Ultra-fast delivery — \"95% of transfers arrive in under 3 minutes\"</li>\n<li>Transparent pricing — \"no surprises, the amount shown is what arrives\"</li>\n<li>Simple app — \"my mother can use it without help\"</li>\n<li>Competitive rates on African and South Asian corridors</li>\n<li>Multiple payment options — debit card, bank transfer, Google Pay, Apple Pay, UPI</li>\n<li>Reliable, consistent service</li>\n</ul>\n\n<p><strong>Common complaints:</strong></p>\n<ul>\n<li>Verification can delay first transfer</li>\n<li>No cash pickup — mobile money and bank deposit only</li>\n</ul>\n\n<p><strong>Our assessment:</strong> A 4.7 Trustpilot rating from 32,000+ reviews is extraordinary — it's the highest of any provider we track. Combined with the 95% under-3-minutes delivery stat and 80+ country coverage, TapTap Send has built genuine loyalty in diaspora communities that goes well beyond its early zero-fee positioning.</p>",
      },
    ],
    whoShouldUse: [
      {
        ...
        items: [
          "Regular remittances to Africa (Ghana, Kenya, Nigeria, Senegal, Uganda, Ethiopia, and 50+ more)",
          "Sending to South Asia: Pakistan, Bangladesh, Nepal, Sri Lanka, and India",
          "Users who hate hidden fees and want total cost transparency",
          "Mobile money delivery to M-Pesa, MTN, Wave, bKash, JazzCash, and more",
          "Speed: 95% of transfers arrive in under 3 minutes",
          "Diaspora communities who want a simple, trusted app (4.7/5 Trustpilot, 32,000+ reviews)",
        ],
      },
      {
        heading: "TapTap Send may not be the best choice for",
        items: [
          "Cash pickup — mobile money and bank deposit only (no agent network)",
          "Business payments — personal transfers only",
          "Large transfers over $10,000 — use OFX or TorFX for dedicated dealer support",
          "Developed-country corridors (US→EU, etc.) — TapTap Send is optimised for emerging market destinations",
        ],
      },
    ],
    alternatives: [
    ...
    faqs: [
      {
        ...
        a: "TapTap Send charges zero transfer fees on the majority of corridors. Some corridors do carry a small fee — TapTap Send is transparent about this before you confirm. Beyond any fees, TapTap Send applies a ~0.7% exchange rate markup (one of the lowest in the market). On a $1,000 transfer, the markup costs approximately $7. This total cost is competitive with and often cheaper than providers that charge both fees and exchange rate markup. Always compare the total receive amount rather than just the headline fee.",
      },
      {
        q: "What payment methods does TapTap Send accept?",
        a: "TapTap Send accepts debit card, bank transfer, Google Pay, Apple Pay, and UPI (India). This broad range of funding options makes it accessible for different types of senders — from those who prefer the immediacy of a card to those who want the low cost of a bank transfer.",
      },
      {
        q: "Is TapTap Send safe?",
        a: "Yes. TapTap Send is regulated by the Financial Conduct Authority (FCA) in the UK and FinCEN in the US. Customer funds are safeguarded in accordance with FCA e-money regulations. The company was founded by Michael Faye — who also founded GiveDirectly — and the team includes veterans from WorldRemit and Wave with decades of combined experience in regulated financial services. TapTap Send holds the highest Trustpilot rating in money transfer (4.7 from 32,000+ reviews) — a strong signal of reliability. The company uses bank-grade security including encryption and biometric authentication.",
      },
      {
        q: "How does TapTap Send compare to Wise?",
        a: "TapTap Send and Wise are both excellent transfer services with different strengths. Wise uses the mid-market exchange rate (0% markup) and charges a small fee (0.4–0.7%). TapTap Send charges zero or minimal fees with a ~0.7% markup — total cost is often within 0.3% of each other. Both support 80+ countries. Wise offers bank transfer, card, and Apple/Google Pay; TapTap Send also supports debit card, bank transfer, Google Pay, Apple Pay, and UPI. Wise has a website and app; TapTap Send is mobile-first. Wise offers a broader multi-currency account globally; TapTap Send's multi-currency account is currently available for UK and EU users. TapTap Send's 4.7 Trustpilot rating edges Wise's 4.3. For African and South Asian corridors, compare both on SendMoneyCompare — the winner varies by corridor and amount.",
      },
      {
        q: "Which countries can I send to with TapTap Send?",
        a: "TapTap Send supports 80+ receive countries across 65+ currencies. Major destinations include Ghana, Kenya, Nigeria, Senegal, Uganda, Ethiopia, Rwanda, Cameroon, Tanzania, Zimbabwe, Morocco, DR Congo (Africa), Pakistan, Bangladesh, Nepal, Sri Lanka, India (South Asia), Philippines, Colombia, Mexico, Guatemala, and many more. You can send from the UK, US, Canada, Belgium, France, Germany, Ireland, Italy, Netherlands, Spain, and several other European countries. Coverage now rivals Wise and Remitly across the most important diaspora corridors.",
      },
      {
        q: "Can I send money to India with TapTap Send?",
        a: "Yes — India is supported by TapTap Send. TapTap Send also accepts UPI as a funding method for senders in India, making it a strong option for the India corridor from both a sending and receiving perspective. Compare TapTap Send alongside Wise and Remitly on our comparison tool to find the best INR rate at the time of sending.",
      },
    ],
  },
  {
