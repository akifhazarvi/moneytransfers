  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "TapTap Send accepts Visa and Mastercard debit cards (not prepaid, not corporate, not Amex), bank transfer via open banking, Google Pay, Apple Pay, Bancontact (Belgium), PostePay (Italy), and UPI for senders in India. Credit cards are not accepted. If you try to pay with a credit card via Apple Pay or Google Pay, it may be declined — always use your debit card or bank transfer.",
      },
      {
