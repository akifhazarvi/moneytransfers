  ...
  "uae-to-nepal": {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. IME Money Transfer supports direct payout to IME Pay (its own wallet) and increasingly to eSewa via interoperability. Prabhu Money supports direct deposit to Prabhu Pay. Wise and Remitly route through Nepal-side bank accounts, which the recipient then top-ups to eSewa or Khalti — adding 1–2 minutes per step. eSewa (operated by F1Soft) is the largest Nepali wallet with over 8 million users; Khalti is second with 6 million; IME Pay is third with about 4 million but the most tightly integrated with the IME remittance flow. For a recipient who already uses eSewa as their daily wallet, sending via Wise to their Global IME or NMB account keeps the payout in the banking system — they move it to eSewa themselves in seconds.",
      },
      {
