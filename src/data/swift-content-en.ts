...
export const swiftContentEn: SwiftContent = {
  ...
  mexico: {
    ...
    bullets: [
      ...
      "SWIFT and SPEI answer different questions and it's worth knowing which one your transfer actually uses: a traditional SWIFT wire into a Mexican bank routes through correspondent banks and typically settles in one to three business days, while a specialist provider that partners directly with a Mexican bank can push USD-to-MXN payments straight into SPEI, which settles in seconds. Most specialist providers on this corridor are using the SPEI rail rather than SWIFT, which is a meaningful part of why they consistently deliver faster and cheaper than a bank wire on the same corridor — check today's USD to MXN comparison above for who is quoting best right now.",
      "Since 1 January 2026 a US federal excise tax of 1% applies to covered remittance transfers to Mexico funded with cash, money orders, cashier's cheques or similar physical instruments; transfers funded from a bank account or with a US-issued debit or credit card are excluded. This applies regardless of whether the transfer is routed via SWIFT or a specialist's direct-to-SPEI rail — it depends on how you pay, not how the money travels once it leaves your account.",
    ],
  },
  china: {
