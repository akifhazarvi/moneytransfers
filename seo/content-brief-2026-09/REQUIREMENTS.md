...
| A7 / §10-A.7 | Fresh SiteLiner crawl: every processed page below 30% | Open. Local diagnostic is not SiteLiner. Follow-up fixes false-success behavior for high-overlap/missing targets; four regression cases pass. |
