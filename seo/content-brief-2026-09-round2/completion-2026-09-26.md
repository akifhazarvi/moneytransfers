...
| 0 | Author photo, /about/awais-imran | **Done** | The photo the owner supplied is at `/images/authors/awais-imran.jpeg` (800×800). It renders on the author page and in bylines, and goes into the page's Person `image`. |
